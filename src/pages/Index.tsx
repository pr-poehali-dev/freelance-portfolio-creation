  ...
  const reviews = [
    {
      name: "Анна Сергеева",
      role: "CEO стартапа",
      text: "Юра создал отличные промпты для нашего ИИ-ассистента. Качество ответов улучшилось в разы!",
      rating: 5
    },
    {
      name: "Михаил Петров",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 font-body leading-relaxed">
                Привет! Меня зовут Юра, и я фрилансер с многолетним опытом в области дизайна и промптинженеринга. 
                Специализируюсь на создании уникальных визуальных решений и оптимизации ИИ-систем.
              </p>
